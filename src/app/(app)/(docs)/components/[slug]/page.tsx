...
export async function generateMetadata({
  ...
  const ogImage =
    image ||
    `/og/portfolio?title=${encodeURIComponent(title)}&kicker=Component&metric=${encodeURIComponent(SITE_INFO.name)}`;
...
function getPageJsonLd(post: Post): WithContext<PageSchema> {
  ...
  return {
    ...
    image:
      post.metadata.image ||
      `/og/portfolio?title=${encodeURIComponent(post.metadata.title)}&kicker=Component&metric=${encodeURIComponent(SITE_INFO.name)}`,
